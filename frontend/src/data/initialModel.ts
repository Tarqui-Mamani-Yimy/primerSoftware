import { UMLClassNode, UMLRelationship, Collaborator } from '../types';
...
export const INITIAL_CLASSES: UMLClassNode[] = [
  {
    ...
    methods: [
      { id: 'c_m1', name: 'verifyKyc()', returnType: 'Boolean', visibility: '+' }
    ]
  },
  {
    id: 'order',
  ...
  },
  {
    ...
    methods: [
      { id: 'oi_m1', name: 'getSubtotal()', returnType: 'BigDecimal', visibility: '+' }
    ]
  },
  {
    id: 'payment',
    ...
    methods: [
      { id: 'p_m1', name: 'execute()', returnType: 'PaymentStatus*', visibility: '+', isAbstract: true }
    ]
  },
  {
    id: 'cc-payment',
    ...
    methods: [
      { id: 'cc_m1', name: 'execute()', returnType: 'PaymentStatus', visibility: '+' }
    ]
  },
  {
    id: 'stripe-payment',
    ...
    width: 230,
    attributes: [
      { id: 'sp_intent', name: 'stripePaymentIntentId', type: 'String', visibility: '-', annotations: ['@NotNull'] },
    ],
    methods: [
      { id: 'sp_m1', name: 'execute()', returnType: 'PaymentStatus', visibility: '+' }
    ]
  }
];

export const INITIAL_RELATIONSHIPS: UMLRelationship[] = [
  {
    id: 'rel-cust-order',
    sourceId: 'customer',
    targetId: 'order',
  ...
  {
    id: 'rel-stripe-payment',
    sourceId: 'stripe-payment',
    targetId: 'payment',
    type: 'generalization'
  }
];
...
export const INITIAL_COLLABORATORS: Collaborator[] = [
  {
    ...
    x: 540,
    y: 110,
    inspectingText: 'Sarah • Inspecting Order.pk'
  },
  {
    id: 'alex',
    name: 'Alex Kumar',
    ...
    x: 780,
    y: 220,
    inspectingText: 'Alex • Reviewing OrderItem'
  },
  {
    id: 'you',
    name: 'You (Lead)',
