class AppStrings {
  ...
  static const methods = 'Métodos';
  static const relationships = 'Relaciones';
  static const addRelationship = 'Agregar relación';
  static const noRelationships = 'No hay relaciones definidas.';
  static const noMembers = 'No hay elementos definidos.';
  static const add = 'Agregar';
  static const edit = 'Editar';
  static const delete = 'Eliminar';
  static const attributeName = 'Nombre del atributo';
  static const attributeType = 'Tipo del atributo';
  static const methodName = 'Nombre del método';
  static const returnType = 'Tipo de retorno';
  static const relationshipType = 'Tipo de relación';
  static const sourceClass = 'Clase origen';
  static const targetClass = 'Clase destino';
  static const sourceMultiplicity = 'Cardinalidad origen';
  static const targetMultiplicity = 'Cardinalidad destino';
  static const relationshipLabel = 'Etiqueta (opcional)';
  static const manualValidationError = 'Revisá los datos y evitá duplicados.';
  static const confirmDeleteMember = '¿Eliminar este elemento?';
