...
// project assignment with live diagram counts, diagram CRUD with forced
// schemaVersion/id normalization, version appends with max+1 numbering, and
// restore-as-new-write semantics.
package service
